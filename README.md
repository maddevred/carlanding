...
This is an application to host a sample website for a detailing business. Built using HTML/CSS, React bootstrap, Javascript, and React-Scroll (open source code here:
<br>
...
<em> open here<em> https://carlanding.herokuapp.com/
